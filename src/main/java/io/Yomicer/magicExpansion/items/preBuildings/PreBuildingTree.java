...
public class PreBuildingTree extends SimpleSlimefunItem<ItemUseHandler> implements NotPlaceable {
    ...
    public PreBuildingTree(ItemGroup category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe,String buildingName) {
    ...
    public PreBuildingTree(ItemGroup category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe,String buildingName, String originName,String replaceName) {
        super(category, item, recipeType, recipe);
        this.buildingName = buildingName;
